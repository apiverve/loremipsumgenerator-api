// Package loremipsumgenerator provides a Go client for the Lorem Ipsum Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/loremipsumgenerator?utm_source=go&utm_medium=readme
package loremipsumgenerator
...
// Request contains the parameters for the Lorem Ipsum Generator API.
//
// Parameters:
//   - paragraphs: integer - The number of paragraphs to generate [min: 1, max: 100]
//   - startwithlorem: boolean - Start the text with 'Lorem ipsum dolor sit amet'
//   - maxlength: integer - The maximum length of the generated text (0 for no limit) [min: 0]
type Request struct {
	Paragraphs int `json:"paragraphs,omitempty"` // Optional
	Startwithlorem bool `json:"startwithlorem,omitempty"` // Optional
	Maxlength int `json:"maxlength,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"paragraphs": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(100)},
		"startwithlorem": {Type: "boolean", Required: false},
		"maxlength": {Type: "integer", Required: false, Min: float64Ptr(0)},
	}
...
// ResponseData contains the data returned by the Lorem Ipsum Generator API.
