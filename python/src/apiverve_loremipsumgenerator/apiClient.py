...
class LoremipsumgeneratorAPIClient:
    ...
    VALIDATION_RULES = {
        "paragraphs": {"type": "integer", "required": False, "min": 1, "max": 100, "default": 1},
        "startwithlorem": {"type": "boolean", "required": False, "default": True},
        "maxlength": {"type": "integer", "required": False, "min": 0, "default": 0}
    }
