# Lorem Ipsum Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:loremipsumgenerator-api:1.1.14'
}
```
...
```java
import com.apiverve.loremipsumgenerator.LoremIpsumGeneratorAPIClient;
import com.apiverve.loremipsumgenerator.APIResponse;
import com.apiverve.loremipsumgenerator.APIException;

// Initialize the client
LoremIpsumGeneratorAPIClient client = new LoremIpsumGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("paragraphs", 1);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/loremipsumgenerator](https://docs.apiverve.com/ref/loremipsumgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/loremipsumgenerator](https://docs.apiverve.com/ref/loremipsumgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/loremipsumgenerator-api/issues)
