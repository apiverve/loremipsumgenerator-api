...
namespace APIVerve.API.LoremIpsumGenerator
{
    ...
    /// <summary>
    /// Client for the LoremIpsumGenerator API
    /// </summary>
...
#endif
    {
        ...
        {
            { "paragraphs", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 100 } },
            { "startwithlorem", new ValidationRule { Type = "boolean", Required = false } },
            { "maxlength", new ValidationRule { Type = "integer", Required = false, Min = 0 } }
        };
        ...
        private void ValidateParams(LoremIpsumGeneratorQueryOptions options)
        {
