...
{
    class LoremIpsumGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/loremipsumgenerator";

        /// <summary>
        /// Make a GET request to the Lorem Ipsum Generator API
        /// </summary>
        static async Task<JsonDocument> CallLoremIpsumGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;paragraphs&quot;] &#x3D; 3, [&quot;startwithlorem&quot;] &#x3D; true, [&quot;maxlength&quot;] &#x3D; 100 };
        ...
        {
            Console.WriteLine("📤 Calling Lorem Ipsum Generator API...\n");

            var result = await CallLoremIpsumGeneratorAPI();
