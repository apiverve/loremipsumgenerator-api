...
namespace APIVerve\Loremipsumgenerator;
...
/**
 * Client for the Lorem Ipsum Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/loremipsumgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/loremipsumgenerator';
    ...
    private const VALIDATION_RULES = [
        'paragraphs' => ['type' => 'integer', 'required' => false, 'min' => 1, 'max' => 100],
        'startwithlorem' => ['type' => 'boolean', 'required' => false],
        'maxlength' => ['type' => 'integer', 'required' => false, 'min' => 0]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LoremipsumgeneratorClient] {$message}\n";
        }
    }
}
