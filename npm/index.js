...
class loremipsumgeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/loremipsumgenerator');
        }
        ...
        this.validationRules = {"paragraphs":{"type":"integer","required":false,"min":1,"max":100,"default":1},"startwithlorem":{"type":"boolean","required":false,"default":true},"maxlength":{"type":"integer","required":false,"min":0,"default":0}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/loremipsumgenerator`);
        }
    }
...
module.exports = loremipsumgeneratorWrapper;
